...
export default function FAQTabs() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      {/* Tabs */}
      <div className="flex justify-center bg-gray-100 rounded-md p-1 mb-8">
        {tabs.map((tab) => (
          <button
            key={tab.key}
            onClick={() => setActiveTab(tab.key)}
            className={`flex items-center px-6 py-2 rounded-md text-sm font-medium mx-2 transition-colors duration-150 ${
